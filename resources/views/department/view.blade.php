                                        ...
                                        @foreach ($department as $departments)
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        @if($departments->active == 'y')
                                                            <form method="post" action="{{route('department.nonactive', ['id' => $departments->id])}}" class="forms"> {{ csrf_field() }}
                                                                    <button type="submit" class="btn btn-sm btn-raised btn-danger"><small class="fa fa-close"></small></button>
                                                            </form>
                                                        @else
                                                           <form method="post" action="{{route('department.active', ['id' => $departments->id])}}" class="forms"> {{ csrf_field() }}
